...
static SpeakTextActor[][] = {
    "{FFFFFF}Siemka co s³ychaæ? {B400FF}**uœmiecha siê**{FFFFFF}", "{FFFFFF}Witam w czym mogê pomóc?",
    "{FFFFFF}Jak leci?", "{FFFFFF}Hmmm...",
    "{FFFFFF}Nie mam czasu, pogadaj z kimœ innym.", "{FFFFFF}£adne mam ubranie dzisiaj kupi³em.{B400FF}**puszcza oczko**{FFFFFF}",
    "{FFFFFF}Czeœæ.", "{FFFFFF}Co tam?",
    "{FFFFFF}S³ysza³eœ? Chyba coœ wybuch³o.", "{FFFFFF}Chyba pojadê na ryby."
};
